...
import org.septa.android.app.nextarrive.NextToArrive;
import org.septa.android.app.schedules.SchedulesActivity;

/**
 * Created by jkampf on 8/21/17.
 */

public abstract class FirstLevelBaseActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    public static final String TAG = FirstLevelBaseActivity.class.getSimpleName();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_next_to_arrive){
            Intent intent = new Intent(this, NextToArrive.class);
