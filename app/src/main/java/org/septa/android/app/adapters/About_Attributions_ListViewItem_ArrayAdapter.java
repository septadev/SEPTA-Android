/*
 * About_Attributions_ListViewItem_ArrayAdapter.java
 * Last modified on 02-10-2014 10:13-0500 by brianhmayo
 *
...
public class About_Attributions_ListViewItem_ArrayAdapter  extends ArrayAdapter<IconTextPendingIntentModel> {
    private final Context context;
    private final IconTextPendingIntentModel[] values;

    public About_Attributions_ListViewItem_ArrayAdapter(Context context, IconTextPendingIntentModel[] values) {
