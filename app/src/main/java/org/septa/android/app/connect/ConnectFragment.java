            ...
            public void onClick(View v) {
                ...
                if (activity != null) {
                    ...
                    if (viewId == R.id.facebook_arrow) {
                        AnalyticsManager.logContentType(TAG, AnalyticsManager.CUSTOM_EVENT_FACEBOOK, AnalyticsManager.CUSTOM_EVENT_ID_CONNECT, null);
                    } else if (viewId == R.id.twitter_arrow) {
                        AnalyticsManager.logContentType(TAG, AnalyticsManager.CUSTOM_EVENT_TWITTER, AnalyticsManager.CUSTOM_EVENT_ID_CONNECT, null);
                    } else {
            ...
            public void onClick(View v) {
                ...
                if (activity != null) {
                    ...
                    if (viewId == R.id.chat_arrow) {
                        AnalyticsManager.logContentType(TAG, AnalyticsManager.CUSTOM_EVENT_LIVE_CHAT, AnalyticsManager.CUSTOM_EVENT_ID_CONNECT, null);
                    } else if (viewId == R.id.comment_arrow) {
                        AnalyticsManager.logContentType(TAG, AnalyticsManager.CUSTOM_EVENT_SEND_COMMENT, AnalyticsManager.CUSTOM_EVENT_ID_CONNECT, null);
                    } else {
                        Log.e(TAG, String.format("Could not track event analytics for url: %s", url));
                    }
