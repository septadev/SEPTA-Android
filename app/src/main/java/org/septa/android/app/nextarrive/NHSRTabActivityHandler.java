...
public class NHSRTabActivityHandler extends BaseTabActivityHandler {
    public NHSRTabActivityHandler(String title) {
        super(title);
    }

    @Override
    public Fragment getFragment() {
        return NHSRTabActivityHandler.PlaceholderFragment.newInstance();
    }
