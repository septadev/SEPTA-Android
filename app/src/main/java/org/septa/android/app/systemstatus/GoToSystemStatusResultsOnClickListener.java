    ...
    public void onClick(View v) {
        if (context != null) {
            ...
            if (NextToArriveResultsActivity.class.equals(context.getClass())) {
                AnalyticsManager.logContentViewEvent(TAG, AnalyticsManager.CUSTOM_EVENT_SYSTEM_STATUS_FROM_NTA, AnalyticsManager.CUSTOM_EVENT_ID_SYSTEM_STATUS, null);
            } else if (TransitViewResultsActivity.class.equals(context.getClass())) {
                AnalyticsManager.logContentViewEvent(TAG, AnalyticsManager.CUSTOM_EVENT_SYSTEM_STATUS_FROM_TRANSITVIEW, AnalyticsManager.CUSTOM_EVENT_ID_SYSTEM_STATUS, null);
            } else if (MainActivity.class.equals(context.getClass())) {
                AnalyticsManager.logContentViewEvent(TAG, AnalyticsManager.CUSTOM_EVENT_SYSTEM_STATUS_FROM_FAVORITES, AnalyticsManager.CUSTOM_EVENT_ID_SYSTEM_STATUS, null);
            } else {
